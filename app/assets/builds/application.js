...
var require_dropdown = __commonJS({
  "node_modules/bootstrap/js/dist/dropdown.js"(exports, module) {
    (function(global, factory) {
    ...
    })(exports, function(Popper2, BaseComponent2, EventHandler2, Manipulator2, SelectorEngine2, index_js) {
      "use strict";
      ...
      const Popper__namespace = /* @__PURE__ */ _interopNamespaceDefault(Popper2);
      ...
      const SELECTOR_DATA_TOGGLE2 = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)';
      const SELECTOR_DATA_TOGGLE_SHOWN2 = `${SELECTOR_DATA_TOGGLE2}.${CLASS_NAME_SHOW2}`;
      ...
      const PLACEMENT_TOP2 = index_js.isRTL() ? "top-end" : "top-start";
      const PLACEMENT_TOPEND2 = index_js.isRTL() ? "top-start" : "top-end";
      const PLACEMENT_BOTTOM2 = index_js.isRTL() ? "bottom-end" : "bottom-start";
      const PLACEMENT_BOTTOMEND2 = index_js.isRTL() ? "bottom-start" : "bottom-end";
      const PLACEMENT_RIGHT2 = index_js.isRTL() ? "left-start" : "right-start";
      const PLACEMENT_LEFT2 = index_js.isRTL() ? "right-start" : "left-start";
      ...
      class Dropdown2 extends BaseComponent2 {
        ...
        show() {
          ...
          const showEvent = EventHandler2.trigger(this._element, EVENT_SHOW2, relatedTarget);
          ...
          EventHandler2.trigger(this._element, EVENT_SHOWN2, relatedTarget);
        }
        hide() {
          if (index_js.isDisabled(this._element) || !this._isShown()) {
            return;
        ...
        _completeHide(relatedTarget) {
          const hideEvent = EventHandler2.trigger(this._element, EVENT_HIDE2, relatedTarget);
          ...
          EventHandler2.trigger(this._element, EVENT_HIDDEN2, relatedTarget);
        }
        _getConfig(config) {
        ...
        _selectMenuItem({
          ...
          const items = SelectorEngine2.find(SELECTOR_VISIBLE_ITEMS2, this._menu).filter((element) => index_js.isVisible(element));
          if (!items.length) {
            return;
          }
          index_js.getNextActiveElement(items, target, key === ARROW_DOWN_KEY2, !items.includes(target)).focus();
        }
        // Static
        ...
        static clearMenus(event) {
          if (event.button === RIGHT_MOUSE_BUTTON2 || event.type === "keyup" && event.key !== TAB_KEY2) {
            return;
          }
        ...
        static dataApiKeydownHandler(event) {
          ...
          const getToggleButton = this.matches(SELECTOR_DATA_TOGGLE2) ? this : SelectorEngine2.prev(this, SELECTOR_DATA_TOGGLE2)[0] || SelectorEngine2.next(this, SELECTOR_DATA_TOGGLE2)[0] || SelectorEngine2.findOne(SELECTOR_DATA_TOGGLE2, event.delegateTarget.parentNode);
      ...
      EventHandler2.on(document, EVENT_KEYDOWN_DATA_API2, SELECTOR_DATA_TOGGLE2, Dropdown2.dataApiKeydownHandler);
      EventHandler2.on(document, EVENT_KEYDOWN_DATA_API2, SELECTOR_MENU2, Dropdown2.dataApiKeydownHandler);
      EventHandler2.on(document, EVENT_CLICK_DATA_API2, Dropdown2.clearMenus);
